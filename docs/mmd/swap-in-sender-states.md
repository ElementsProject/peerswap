...
State_SwapInSender_ClaimSwapCltv --> State_ClaimedCltv: Event_ActionSucceeded
State_SwapInSender_ClaimSwapCltv --> State_SwapInSender_ClaimSwapCltv: Event_OnRetry
State_WaitCltv
State_WaitCltv --> State_SwapInSender_ClaimSwapCltv: Event_OnCltvPassed
State_SwapCanceled
...
State_SwapInSender_AwaitClaimPayment --> State_SwapInSender_ClaimSwapCltv: Event_OnCltvPassed
State_SwapInSender_AwaitClaimPayment --> State_SwapInSender_ClaimSwapCltv: Event_OnCancelReceived
...
State_SwapInSender_ClaimSwapCoop --> State_WaitCltv: Event_ActionFailed
