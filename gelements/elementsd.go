...
func (b *Elements) StartUp(host string, port uint) {
	if host == "" {
...
func (g *GetBlockCountRequest) Name() string {
	return "getblockcount"
}

func (b *Elements) GetBlockCount() (int, error) {
	var result int
	err := b.request(&GetBlockCountRequest{}, &result)
	if err != nil {
		return -1,err
	}
	return result, nil
...
func (b *Elements) GetNewAddress(addrType AddrType) (string, error) {
	var result string
