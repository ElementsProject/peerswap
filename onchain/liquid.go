...
func (l *LiquidOnChain) CreateOpeningTransaction(swapParams *swap.OpeningParams) (txHex, txid string, fee uint64, vout uint32, err error) {
	...
	return txHex, txId, fee, vout, nil
}
