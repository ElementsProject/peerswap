...
func (l *Client) CreateOpeningTransaction(swapParams *swap.OpeningParams) (unpreparedTxHex, txId string, fee uint64, vout uint32, err error) {
	...
	return unpreparedTxHex, openingTx.TxHash().String(), fee, vout, nil
}
