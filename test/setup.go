...
func clnclnSetupWithConfig(t *testing.T, fundAmt, pushAmt uint64, clnConf []string, policyConf []byte) (*testframework.BitcoinNode, []*testframework.CLightningNode, string) {
